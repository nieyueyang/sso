...
//
//
//    @Pointcut("execution(* com.deyun.sso.ctrl..*.*(..))")
...
//        try {
//            logger.info("执行Controller开始: " + pjp.getSignature() + " 参数：");
//            //处理入参特殊字符和sql注入攻击
//           // checkRequestParam(pjp);
//            //执行访问接口操作
//          //  apiResponse = (APIResponse) pjp.proceed(pjp.getArgs());
//            try{
//                logger.info("执行Controller结束: " + pjp.getSignature() + "， 返回值：");
...
//    public String handleControllerMethod2(JoinPoint pjp,Exception e){
//        //Stopwatch stopwatch = Stopwatch.createStarted();
//
//        // APIResponse apiResponse;
//        try {
